...
import boestiLogo from '@/assets/boesti-logo.png';
    ...
    <header className="header-academic py-8 px-4">
      <div className="max-w-4xl mx-auto text-center">
        <div className="flex items-center justify-center mb-6">
          <img 
            src={boestiLogo} 
            alt="Bamidele Olomilua University Logo" 
            className="h-16 md:h-20 object-contain"
          />
        </div>
        
        <h1 className="text-3xl md:text-4xl font-bold mb-3">
          BOESTI Admission Inquiry Chatbot
        </h1>
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-lg px-4 py-2 inline-block">
          ...
          <p className="text-xs opacity-80">
            Computer Science Department • Bamidele Olomilua University (BOESTI)
          </p>
        </div>
      </div>
    </header>
